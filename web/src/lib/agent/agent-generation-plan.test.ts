...
test("updates generated config metadata before run_generation", () => {
    ...
    const next = updateAgentGenerationOps(ops, "existing", { model: "seedance-2.0-720p-economy", seconds: "10" });
    assert.deepEqual(next, [
        { type: "update_node", id: "existing", metadata: { model: "seedance-2.0-720p-economy", seconds: "10" } },
