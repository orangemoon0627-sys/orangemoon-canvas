...
const MB = 1024 * 1024;
const DEFAULT_REFERENCES = { images: 9, videos: 3, audios: 3, imageMaxBytes: 12 * MB, videoMaxBytes: 48 * MB, audioMaxBytes: 16 * MB };
const PRO_REFERENCES = { ...DEFAULT_REFERENCES, images: 4, audios: 1 };
const CC_REFERENCES = { ...DEFAULT_REFERENCES, videos: 0 };
...
export const PROVIDER_MODELS: ProviderModel[] = [
    ...
    videoModel("qy-seedance-2.0-fast-480p", "Seedance 2.0 480P Fast（旧配置）", "480p", { unit: "second", usd: 1 / 6 }, DEFAULT_REFERENCES, { upstreamModel: "qy-seedance-2.0-fast", allowedDurations: [5, 10, 15], aspectRatios: QY_RATIOS, tier: "fast" }),
    videoModel("qy-seedance-2.0-fast-720p", "Seedance 2.0 720P Fast（旧配置）", "720p", { unit: "second", usd: 0.2 }, DEFAULT_REFERENCES, { upstreamModel: "qy-seedance-2.0-fast", allowedDurations: [5, 10, 15], aspectRatios: QY_RATIOS, tier: "fast" }),
    videoModel("Seedance 2.0-fast-720p", "Seedance 2.0 720P 经济（旧配置）", "720p", { unit: "second", usd: 0.1 }, { ...DEFAULT_REFERENCES, videos: 0, audios: 0 }, { aspectRatios: ["16:9", "9:16", "1:1", "4:3", "3:4"], tier: "economy" }),
    videoModel("cc-seedance2.0 480p-fast-nsp", "Seedance 2.0 480P Fast（旧配置）", "480p", { unit: "second", usd: 0.33 }, CC_REFERENCES, { upstreamSource: "web", tier: "fast" }),
    videoModel("cc-seedance2.0 480p-nsp", "Seedance 2.0 480P 标准（旧配置）", "480p", { unit: "second", usd: 0.36 }, CC_REFERENCES, { upstreamSource: "web", tier: "standard" }),
    videoModel("mg-seedance2.0 -1080p", "Seedance 2.0 1080P 标准（旧配置）", "1080p", { unit: "second", usd: 0.67 }, DEFAULT_REFERENCES, { upstreamSource: "web", tier: "standard" }),
    videoModel("mg-seedance2.0 -480p", "Seedance 2.0 480P Pro（旧配置）", "480p", { unit: "second", usd: 0.268 }, PRO_REFERENCES, { upstreamSource: "web", tier: "pro" }),
    videoModel("mg-seedance2.0 -480p fast", "Seedance 2.0 480P Fast（旧配置）", "480p", { unit: "second", usd: 0.165 }, PRO_REFERENCES, { upstreamSource: "web", tier: "fast" }),
    videoModel("mg-seedance2.0 -480p mini", "Seedance 2.0 480P Mini（旧配置）", "480p", { unit: "second", usd: 0.158 }, PRO_REFERENCES, { upstreamSource: "web", tier: "mini" }),
    videoModel("mg-seedance2.0 -720p fast", "Seedance 2.0 720P Fast（旧配置）", "720p", { unit: "second", usd: 0.298 }, PRO_REFERENCES, { upstreamSource: "web", tier: "fast" }),
    videoModel("mg-seedance2.0 -720p mini", "Seedance 2.0 720P Mini（旧配置）", "720p", { unit: "second", usd: 0.228 }, PRO_REFERENCES, { upstreamSource: "web", tier: "mini" }),
    videoModel("mg-seedance2.0 -720p pro", "Seedance 2.0 720P Pro（旧配置）", "720p", { unit: "second", usd: 0.4 }, PRO_REFERENCES, { upstreamSource: "web", tier: "pro" }),
    videoModel("mg-seedance2.0 -480p-fast-gz-15s", "Seedance 2.0 480P Fast（15 秒旧配置）", "480p", { unit: "generation", usd: 3.98 }, DEFAULT_REFERENCES, { fixedDuration: 15, upstreamSource: "web", tier: "fast" }),
    videoModel("mg-seedance2.0 -480p-gz-15s", "Seedance 2.0 480P 标准（15 秒旧配置）", "480p", { unit: "generation", usd: 5.4 }, DEFAULT_REFERENCES, { fixedDuration: 15, upstreamSource: "web", tier: "standard" }),
    videoModel("mg-seedance2.0 -480p-mini-gz-15s", "Seedance 2.0 480P Mini（15 秒旧配置）", "480p", { unit: "generation", usd: 2.95 }, DEFAULT_REFERENCES, { fixedDuration: 15, upstreamSource: "web", tier: "mini" }),
    videoModel("mg-seedance2.0 -720p-fast-gz-15s", "Seedance 2.0 720P Fast（15 秒旧配置）", "720p", { unit: "generation", usd: 5 }, DEFAULT_REFERENCES, { fixedDuration: 15, upstreamSource: "web", tier: "fast" }),
    videoModel("mg-seedance2.0 -720p-gz-15s", "Seedance 2.0 720P 标准（15 秒旧配置）", "720p", { unit: "generation", usd: 6.3 }, DEFAULT_REFERENCES, { fixedDuration: 15, upstreamSource: "web", tier: "standard" }),
    videoModel("mg-seedance2.0 -720p-mini-gz-15s", "Seedance 2.0 720P Mini（15 秒旧配置）", "720p", { unit: "generation", usd: 2.88 }, DEFAULT_REFERENCES, { fixedDuration: 15, upstreamSource: "web", tier: "mini" }),
...
export function providerQuantity(model: ProviderModel, requested: number) {
    if (model.billing.unit === "generation") return 1;
